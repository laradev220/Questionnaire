...
@section('content')
    <div class="bg-white rounded-xl shadow-xl border border-gray-100 p-8">
        <h1 class="text-3xl font-extrabold text-gray-900 mb-6">Add Question</h1>
            ...
            <form method="POST" action="/admin/questions/add" class="space-y-6">
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded font-semibold">Add Question</button>
                </div>
            </form>
    </div>
@endsection