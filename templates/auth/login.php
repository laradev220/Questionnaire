                ...
                <div class="text-center text-white z-10 animate-fade-in">
                    <div class="mb-8">
                        <svg class="w-32 h-32 mx-auto mb-6 animate-float" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white opacity-90"/>
                        </svg>
                    </div>
            ...
            <div class="max-w-md w-full animate-slide-up">
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="<?php echo BASE_PATH; ?>/register" class="text-emerald-600 hover:text-emerald-800 font-medium transition-colors duration-300">Register here</a>
                    </p>
                </div>
            </div>
        </div>
