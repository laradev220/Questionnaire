            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6 pt-16 lg:pt-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded shadow">
                        <h3 class="text-lg font-semibold mb-4">Module Averages</h3>
                        <ul>
                            <?php foreach ($moduleAverages as $avg): ?>
                                <li><?php echo htmlspecialchars($avg['module']); ?>: <?php echo round($avg['avg_score'], 2); ?></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                    <div class="bg-white p-6 rounded shadow">
                        ...
                        <ul>
                            <?php foreach ($scoreDistribution as $dist): ?>
                                <li><?php echo $dist['score']; ?>: <?php echo $dist['count']; ?></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                </div>
